  ...
  return (
    <section id="services" className="py-24 bg-gradient-to-br from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-orange-400/15 to-pink-400/15 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-white via-blue-50 to-indigo-50 p-10 rounded-3xl shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 animate-fade-in" style={{animationDelay: '0.2s'}}>
